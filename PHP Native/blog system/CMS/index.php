<?php 
  require './Admin/helper/DB_connection.php';
  require './Admin/helper/functions.php';
  ##################################################################################################
  $sql = "select blogs.* , category.title as cat_title , users.first_name , users.last_name , users.image as user_image from blogs inner join category on blogs.cat_id = category.id    
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="right-nav align-items-center d-flex justify-content-end list-inline"> <a class="btn btn-white btn-sm" href="./Admin/login.php">Login</a>
              <div class="search">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="post">
          <div class="post-image">
            <img class="img-fluid h-100 w-100" src="<?php echo url('/blogs/uploads/'.$Raw['image'])?>" alt="">
          </div>
          <div class="post-desc">
            <div class="post-date"><?php echo date('d',$Raw['pu_date']);?> <span><?php echo date('F Y',$Raw['pu_date']);?></span>
            </div>
            ...
            <div class="post-author">
              <div class="post-author-img">
                <img class="img-fluid"  src="<?php echo url('/Users/uploads/'.$Raw['user_image'])?>"  alt="">
              </div> <span><?php echo $Raw['first_name'] . ' ' . $Raw['last_name'] ;?></span>
            </div>
          </div>
        </div>
      </div>
